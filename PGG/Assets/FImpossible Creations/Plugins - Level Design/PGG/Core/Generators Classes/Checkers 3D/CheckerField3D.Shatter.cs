...
namespace FIMSpace.Generating.Checker
{
    public partial class CheckerField3D
    {
        ...
        public struct ShatterFraction
        {
            ...
            internal ShatterFraction Split(List<ShatterFraction> shapes, FGenerators.DefinedRandom random = null, float sliceRandomize = 0f)
            {
                Bounds mainBounds = B;
            ...
            internal CheckerField3D ToCheckerField(FieldPlanner copySettingsFrom = null, bool centerize = false)
            {
